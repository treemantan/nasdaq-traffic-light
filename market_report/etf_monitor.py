...
DEFAULT_ETF_SPECS = [
    ...
    ETFSpec("chip", "Amundi MSCI Semiconductors UCITS ETF", "CHIP.L", "Semiconductor", "Amundi"),
    ...
    ETFSpec("flxk", "Franklin FTSE Korea UCITS ETF", "FLXK.L", "South Korea Equity", "Franklin"),
